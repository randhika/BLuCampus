...
public class FtiFragment extends Fragment{
    ...
    protected FtiFragment.LayoutManagerType mCurrentLayoutManagerType;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnFilter = (Button)rootView.findViewById(R.id.btn_filter_info);
        ...
        mCurrentLayoutManagerType = FtiFragment.LayoutManagerType.LINEAR_LAYOUT_MANAGER;

        if (savedInstanceState != null) {
            // Restore saved layout manager type.
            mCurrentLayoutManagerType = (FtiFragment.LayoutManagerType) savedInstanceState
        ...
        btnFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity().getApplicationContext(), ChooseFaculty.class);
...
//        });
     ...
     */
    public void setRecyclerViewLayoutManager(FtiFragment.LayoutManagerType layoutManagerType) {
        ...
        switch (layoutManagerType) {
            case GRID_LAYOUT_MANAGER:
                ...
                mCurrentLayoutManagerType = FtiFragment.LayoutManagerType.GRID_LAYOUT_MANAGER;
                break;
